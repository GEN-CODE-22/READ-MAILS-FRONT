...
export const NavBar: FC = ({}) => {
  ...
  return (
    <header className="h-16 md:h-20 shadow-md  bg-white items-center relative z-10">
      <div className="flex flex-center flex-col h-full justify-center mx-auto relative px-3 text-white z-10">
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68">
          ...
          <div className="flex items-center justify-end ml-5 mr-0 p-1 relative text-black w-full sm:mr-0 sm:right-auto">
            <a href="#" className="block relative ">
              <Tooltip title={"Configuración"} onClick={onClick}>
                <div>
                  {!!auth ? (
                    <div className="flex">
